...
const BenefitsSection = React.forwardRef((props, ref) => { return (
  <section ref={ref} className="py-20 min-h-screen">
    <div className="container mx-auto w-[1240px]">
      <h2 className="text-3xl font-bold text-center mb-12">Лучшие условия для пользователей</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <BenefitCard
          ...
          text="Наши специалисты работают кругосуточно, чтобы помочь тебе в любой момент."
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8"> {/* mt-8 for spacing between rows */}
        <BenefitCard
