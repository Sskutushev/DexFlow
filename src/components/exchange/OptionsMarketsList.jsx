...
import { mockOptionsPairs } from '../../mock/optionsData';

const OptionsMarketsList = ({ onSelectPair }) => {
  const [searchTerm, setSearchTerm] = useState('');

  const filteredPairs = mockOptionsPairs.filter(pair =>
...
export default OptionsMarketsList;
