...
import { mockAssetsPairs } from '../../mock/assetsData';

const AssetsMarketsList = ({ onSelectPair }) => {
  const [searchTerm, setSearchTerm] = useState('');

  const filteredPairs = mockAssetsPairs.filter(pair =>
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="text-muted">
              <th className="p-2 font-normal">Актив</th>
...
export default AssetsMarketsList;
